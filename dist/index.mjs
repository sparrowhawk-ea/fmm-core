...
class FmmStoreHTML extends FmmStoreBase {
    constructor() {
        super(...arguments);
...
class Fmm {
    static createMinimap(p, parent, ef) {
        ...
        if (parent) {
            ...
            return panel.createMinimap(Object.assign(Object.assign({}, p), { anchor: undefined, usePanelDetail: true }));
        }
        else {
            if (!p.anchor)
                throw new Error(err + 'anchor');
            const panel = new Panel(ef || G.EF, false);
            return panel.createMinimap(Object.assign(Object.assign({}, p), { usePanelDetail: false }));
        }
    }
...
class Detail {
    ...
    refreshDisplay(minimapId) {
        ...
        const labelPrefix = ((_a = data.aggregateLabel) === null || _a === void 0 ? void 0 : _a.concat(': ')) || '';
        ...
        this.value.value = ((_b = data.aggregateValues) === null || _b === void 0 ? void 0 : _b.join('\n')) || data.value || '';
    }
...
FormStoreItem.DEFAULT_FRAMEWORK = {
    ...
    getEnvelope: (_, _e, _l) => undefined,
    getError: (_, _e, _n, _v) => '',
    getLabel: (_, _e) => undefined,
    getValue: (_, _e, _n, _l) => ''
};
...
class Frame {
    ...
    detach() {
        var _a;
        if (this.popup)
            (_a = this.div.parentElement) === null || _a === void 0 ? void 0 : _a.classList.add(Fmm.CLASS.Detached);
        else
    ...
    onDragStart(ev) {
        var _a;
        (_a = ev.dataTransfer) === null || _a === void 0 ? void 0 : _a.setData('text/plain', this.dragData);
    }
...
class Minimap {
    constructor(p, panel) {
        ...
        this.summaryData = Object.assign(Object.assign({}, Snapshot.NULLDATA), { label: p.title });
        this.title = p.title;
    ...
    destructor() {
        ...
        if (!z)
            return;
        this.z = undefined;
        (_a = z.status.parentElement) === null || _a === void 0 ? void 0 : _a.removeChild(z.status);
    ...
    get isPinned() {
        var _a;
        return (_a = this.z) === null || _a === void 0 ? void 0 : _a.pin.isPinned;
    }
    get isPinnedToPanelDetail() {
        var _a, _b;
        return this.isPinned && ((_a = this.z) === null || _a === void 0 ? void 0 : _a.detail) === ((_b = this.z) === null || _b === void 0 ? void 0 : _b.panel.detail);
    }
    detach() {
        const d = this.d;
        const z = this.z;
    ...
    handleLayout(e) {
        var _a, _b;
        if (!e || ((_a = this.d) === null || _a === void 0 ? void 0 : _a.clipContextAncestors.has(e))) {
            this.pendingLayout = true;
            (_b = this.d) === null || _b === void 0 ? void 0 : _b.doUpdates.schedule();
        }
    }
    layout(zoomEvent) {
        const d = this.d;
        ...
        if ((pageRect === null || pageRect === void 0 ? void 0 : pageRect.height) && pageRect.width) {
    ...
    onStatusEnter(ev) {
        var _a, _b;
        ev.stopPropagation();
        if (this.anchored && !((_b = (_a = this.z) === null || _a === void 0 ? void 0 : _a.frame.popup) === null || _b === void 0 ? void 0 : _b.isShowing))
            this.showPopups();
    }
    ;
    takeSnapshot() {
    ...
    snapshotActive(data) {
        var _a;
        if (!this.isPinned)
            (_a = this.z) === null || _a === void 0 ? void 0 : _a.detail.setDisplay(this.minimapId, (this.activeSnapshot = data));
    }
...
class Snapshot {
    constructor(name, p) {
        ...
        this.data = Object.assign(Object.assign({}, Snapshot.NULLDATA), { aggregateLabel, aggregateValues: p.aggregateValuesMap[name], name });
...
export { Fmm, FmmBootstrap4, FmmFormHTML, FmmFrameworkItemHTML, FmmStoreBase, FmmStoreHTML, FmmStoreImpl };
